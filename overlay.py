...
_OVERLAY_HTML = (
    ...
    '<stop offset="0%" stop-color="rgba(50,35,70,0.55)"/><stop offset="100%" stop-color="rgba(30,20,50,0.40)"/></linearGradient>\n'
    '      <filter id="rsh"><feDropShadow dx="0" dy="1.5" stdDeviation="2" flood-opacity=".3"/></filter>\n'
    '    </defs>\n'
    '    <g filter="url(#rsh)">\n'
    f'      <path d="{_LOCK_PATH}" fill="url(#rgl)" fill-rule="evenodd" stroke="rgba(140,110,200,0.30)" stroke-width=".5"/>\n'
    '    </g>\n'
    ...
    '    </defs>\n'
    '    <g filter="url(#psh)">\n'
    f'      <path d="{_LOCK_PATH}" fill="url(#pgl)" fill-rule="evenodd" stroke="rgba(140,110,200,0.30)" stroke-width=".5"/>\n'
    '    </g>\n'
    ...
    '    </defs>\n'
    '    <g filter="url(#tsh)">\n'
    f'      <path d="{_LOCK_PATH}" fill="url(#tgl)" fill-rule="evenodd" stroke="rgba(140,110,200,0.30)" stroke-width=".5"/>\n'
    '    </g>\n'
    '    <circle cx="60" cy="74" r="18" fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="6.6"/>\n'
